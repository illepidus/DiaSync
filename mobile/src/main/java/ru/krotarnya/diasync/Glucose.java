...
public class Glucose implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public Glucose() {
        ...
        error_text_color = ContextCompat.getColor(context, R.color.widget_text_error);
        error_graph_color = ContextCompat.getColor(context, R.color.widget_glucose_error);
        low_text_color = ContextCompat.getColor(context, R.color.widget_text_low);
        low_graph_color = ContextCompat.getColor(context, R.color.widget_glucose_low);
        low_graph_zone_color = ContextCompat.getColor(context, R.color.widget_zone_low);
        normal_text_color = ContextCompat.getColor(context, R.color.widget_text_normal);
        normal_graph_color = ContextCompat.getColor(context, R.color.widget_glucose_normal);
        normal_graph_zone_color = ContextCompat.getColor(context, R.color.widget_zone_normal);
        high_text_color = ContextCompat.getColor(context, R.color.widget_text_high);
        high_graph_color = ContextCompat.getColor(context, R.color.widget_glucose_high);
        high_graph_zone_color = ContextCompat.getColor(context, R.color.widget_zone_high);

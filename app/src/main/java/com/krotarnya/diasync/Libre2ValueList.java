...
public class Libre2ValueList extends Glucose {
    private List<Libre2Value> values;
    ...
    class Libre2CalibratedValueComp implements Comparator<Libre2Value> {
        @Override
    ...
    class Libre2ValueComp implements Comparator<Libre2Value> {
        @Override
        public int compare(Libre2Value v1, Libre2Value v2) {
    ...
    class Libre2TimestampComp implements Comparator<Libre2Value> {
        @Override
        public int compare(Libre2Value v1, Libre2Value v2) {
